...
class MemberTest {
    ...
    public void jpaEventBaseEntity() throws InterruptedException {
        //given
        Member meber = new Member("member1");
        memberRepository.save(meber); //@PrePersist

        Thread.sleep(100);
        meber.setUsername("member2");

        em.flush(); //@PreUpdate
        em.clear();

        //when
        Member findMember = memberRepository.findById(meber.getId()).get();
